...
The backward selection consists of computing the AIC for the full model, and remove the feature that has the largest AIC if its *p-value* is higher than a certain threshold (0.05 in our case). As we can see in Table \ref{table:F_B}b, with this method only 'moisture' is removed.
