...
# setwd("C:\\Users\\Emile....")# setwd("C:\\Users\\Georges\\Documents\\GitHub\\Biostats")
...
tmp <- qqnorm(residuals(lm_best), pch=20)
...
###observed vs fitted
plot(icecream$viscosity ~ fitted(lm_best), pch=20, xlab="Fitted", ylab="Observed")
